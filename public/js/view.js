            ...
            switch (_context.prev = _context.next) {
              case 0:
                ...
                return axios.get(url).then(function (response) {
                  ...
                  _this.feedbacks = response.data[1]; // console.log(response.data);
                });
...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _c(
        "div",
        { staticClass: "mb-5 review container" },
        [
            ...
            return _c("div", { key: index, staticClass: "row" }, [
              _c("div", { staticClass: "col-lg-6 col-md-6 col-sm-12" }, [
                _c(
                  "h6",
                  [
                    _c("b", [_vm._v(_vm._s(feedback.name))]),
                    _vm._v(" "),
                    _c("star-rating", {
                      attrs: {
                        increment: 0.5,
                      ...
                      model: {
                        value: feedback.rate,
                        callback: function($$v) {
                          _vm.$set(feedback, "rate", $$v)
                        },
                        expression: "feedback.rate"
                      }
                    })
                  ],
                  1
                ...
                _c("small", [
                  _vm._v(
                    _vm._s(
                      _vm.month[new Date(feedback.created_at).getMonth()] +
                        " " +
