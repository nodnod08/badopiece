    ...
    <div class="container">
        ...
        <div v-for="item in Items" class="row">
            <div class="img_zoom col l6 m6 s12">
                <v-zoom v-if="type == 'printers'" class="responsive-img" :img="'/storage/img/offer-img/'+item.printer_image1" :height="400" :width="300"></v-zoom>
                <v-zoom v-else class="responsive-img" :img="'/storage/img/offer-img/'+item.cartridge_image" :height="400" :width="300"></v-zoom>
            </div>
