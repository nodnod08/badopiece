      ...
      <div class="top-left">
        <div class="navbar-header">
          <a class="navbar-brand" href="#">
            <img width="110" height="40" :src="'images/logo3.png'" alt="Logo" />
          </a>
              ...
              <div class="dropdown-menu" aria-labelledby="message">
                ...
                <a class="dropdown-item media" href="#">
                  <span class="photo media-left">
                    <img alt="avatar" :src="'admin/images/avatar/1.jpg'" />
                  </span>
                ...
                <a class="dropdown-item media" href="#">
                  <span class="photo media-left">
                    <img alt="avatar" :src="'admin/images/avatar/2.jpg'" />
                  </span>
                  <div class="message media-body">
                ...
                <a class="dropdown-item media" href="#">
                  <span class="photo media-left">
                    <img alt="avatar" :src="'admin/images/avatar/3.jpg'" />
                  </span>
                  <div class="message media-body">
                ...
                <a class="dropdown-item media" href="#">
                  <span class="photo media-left">
                    <img alt="avatar" :src="'admin/images/avatar/4.jpg'" />
                  </span>
                  <div class="message media-body">
